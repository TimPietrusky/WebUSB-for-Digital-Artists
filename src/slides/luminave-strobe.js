...
const notes = (
  <Notes>
    <h3>luminave</h3>
    <p>change the color to strobe</p>
  </Notes>
)

export default (
  <Slide key={uuid()} background="#fff" mixin="--slide-color: black" animationOut={flip.y} animationIn={flip.y}>
    <Plugins.Data luminave={['strobe']}></Plugins.Data>

    {notes}

    <A>
      <div className="strobe-1"></div>
        <DmxChannels channels="6" width="90%" height="10em">
          <Channel background="" label="Red" value="0" className="inactive">
          </Channel>

          <Channel background="" label="Green" value="0" className="inactive">
          </Channel>
          ...
          <Channel background="" label="Strobe" value="50" className="active">
          </Channel>
        </DmxChannels>
    </A>
