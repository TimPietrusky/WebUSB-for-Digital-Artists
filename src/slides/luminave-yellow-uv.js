...
export default (
  <Slide key={uuid()} background="#ff0" mixin="--slide-color: black" animationOut={flip.y} animationIn={flip.y}>
    <Plugins.Data luminave={['yellow']}></Plugins.Data>

    {notes}

    <A>
      <div className="strobe-2"></div>
        <DmxChannels channels="6" width="90%" height="10em">
          <Channel background="" label="Red" value="255" className="active">
          </Channel>
