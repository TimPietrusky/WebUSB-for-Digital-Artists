...
const notes = (
  <Notes>
    <h3>luminave</h3>
    <p>change the color to UV</p>
  </Notes>
)

export default (
  <Slide key={uuid()} background="#5b1ccf" mixin="--slide-color: black" animationOut={flip.y} animationIn={flip.y}>
    <Plugins.Data luminave={['uv']}></Plugins.Data>
    ...
    <A>
      <DmxChannels channels="6" width="90%" height="10em">
        ...
        <Channel background="" label="UV" value="255" className="active">
        </Channel>
